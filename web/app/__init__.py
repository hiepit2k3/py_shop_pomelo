...
def create_app():
    app = Flask(__name__)
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://default:AR9SrBhEsPg3@ep-orange-term-a4m8nc1a.us-east-1.aws.neon.tech:5432/py-shop-pomelo-postgres?sslmode=require'
